...
Figure 6 is a flipped bar plot visualization of the diabetes mortality across counties, which is displayed using a horizontal format (coord_flip) for better readability.
...
Figure 7 is a flipped bar plot visualization of the diabetes mortality across states.
...
In Figure 8, each state is filled with a color corresponding to its mortality rate.
...
From Figure 8, it becomes evident that mortality rates among the AIAN population are higher in the Northern and central regions of the U.S.
